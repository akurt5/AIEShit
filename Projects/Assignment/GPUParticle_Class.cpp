...
GPUParticleHandle::GPUParticleHandle() : m_particles(nullptr), m_maxParticles(0), m_position(0,0,0), m_updateShader(0)
{
	m_vao[0] = 0;
	m_vao[1] = 0;
	m_vbo[0] = 0;
...
GPUParticleHandle::~GPUParticleHandle()
{
	delete[] m_particles;
...
void GPUParticleHandle::Load(unsigned int a_maxParticles, float a_lifetimeMin, float a_lifetimeMax, float a_velocityMin, float a_velocityMax, float a_startSize, float a_endSize, const glm::vec4& a_startColour, const glm::vec4& a_endColour)
{
...
void GPUParticleHandle::Draw(const glm::mat4& a_cameraTransform, const glm::mat4& a_projection)
{
	//////////////////////////////////////////////////////////////////////////
...
void GPUParticleHandle::createBuffers()
{
...
void GPUParticleHandle::createDrawShader()
{
	unsigned int vs = Utility::loadShader("../../Build/shaders/ParticleGPU.vert", GL_VERTEX_SHADER);
	unsigned int fs = Utility::loadShader("../../Build/shaders/ParticleGPU.frag", GL_FRAGMENT_SHADER);
	unsigned int gs = Utility::loadShader("../../Build/shaders/ParticleGPU.geom", GL_GEOMETRY_SHADER);
...
void GPUParticleHandle::createUpdateShader()
{
	// load a text file into an unsigned char buffer
	unsigned char* source = Utility::fileToBuffer("../../Build/shaders/ParticleUpdateGPU.vert");
