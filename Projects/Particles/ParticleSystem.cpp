...
void ParticleEmitter::draw(unsigned int Shader)
{
	glUseProgram(Shader);

	GLint uDiffuseTexture = glGetUniformLocation(Shader, "DiffuseTexture");
	glActiveTexture( 0x84C0 + 0 );
