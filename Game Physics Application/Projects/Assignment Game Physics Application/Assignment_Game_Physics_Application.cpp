#include "Assignment_Game_Physics_Application.h"
#include "Gizmos.h"
#include "Utilities.h"
#include <GL/glew.h>
...
Assignment_Game_Physics_Application::Assignment_Game_Physics_Application(){}
Assignment_Game_Physics_Application::~Assignment_Game_Physics_Application(){}
...
bool Assignment_Game_Physics_Application::onCreate(int a_argc, char* a_argv[]) {
	Gizmos::create();
...
void Assignment_Game_Physics_Application::onUpdate(float a_deltaTime) {
...
void Assignment_Game_Physics_Application::onDraw() {
...
void Assignment_Game_Physics_Application::onDestroy(){
	//!- TUTORIAL
	cleanUpPhsyx();
	//!- TUTORIAL
	Gizmos::destroy();
...
int main(int argc, char* argv[]) {
	Application* app = new Assignment_Game_Physics_Application();
	if (app->create("AIE - Assignment Game Physics Application",DEFAULT_SCREENWIDTH,DEFAULT_SCREENHEIGHT,argc,argv) == true){
		app->run();
	}
	delete app;
	return 0;
