...
bool Projectile_Motion::onCreate(int a_argc, char* a_argv[]) {
	Gizmos::create();
...
void Projectile_Motion::onUpdate(float a_deltaTime) {
...
void Projectile_Motion::onDestroy(){
	//!- TUTORIAL
	cleanUpPhsyx();
	//!- TUTORIAL
	Gizmos::destroy();
...
int main(int argc, char* argv[]) {
	Application* app = new Projectile_Motion();
	if (app->create("AIE - Projectile Motion",DEFAULT_SCREENWIDTH,DEFAULT_SCREENHEIGHT,argc,argv) == true){
		app->run();
	}
	delete app;
	return 0;
